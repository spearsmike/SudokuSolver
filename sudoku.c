...
bool valid(int board[][N], const size_t n, int guess, size_t row, size_t col)
{
    for(int i=0; i<n; i++)
...
size_t countEmpty(int board[][N], size_t n)
{
    size_t count = 0;
...
bool nextBox(int board[][N], const size_t n, size_t* row, size_t* col)
{
...
// solves a Sudoku board of size nxn
// i and j start at 0
// returns true if there is a solution
bool Sudoku(int board[][N], size_t n, size_t i, size_t j)
{
